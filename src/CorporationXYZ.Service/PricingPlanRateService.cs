...
{
    public class PricingPlanRateService : IPricingPlanRateService
    {
        private readonly IRepositoryManager _repository;
        private readonly ILoggerManager _logger;
        private readonly IMapper _mapper;

        public PricingPlanRateService(IRepositoryManager repository, ILoggerManager logger, IMapper mapper)
        {
